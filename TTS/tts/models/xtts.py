...
class Xtts(BaseTTS):
    ...
    def synthesize(self, text, config, speaker_wav, language, speaker_idx, **kwargs):
        ...
        """
        return self.inference_with_config(text, config, ref_audio_path=speaker_wav, language=language, speaker_idx=speaker_idx, **kwargs)

    def inference_with_config(self, text, config, ref_audio_path, language, speaker_idx, **kwargs):
        """
        ...
        return self.full_inference(text, ref_audio_path, language, speaker_idx, **settings)
    ...
    def inference(
        ...
        **hf_generate_kwargs,
        ...
        with torch.no_grad():
            ...
            wav = self.hifigan_decoder(gpt_latents, g=speaker_embedding[speaker_idx])
    ...
    def load_checkpoint(
        ...
        Returns:
            None
        """
        # checkpoint_dir = '/workspace/TTS/recipes/ljspeech/xtts_v2/run/training/GPT_XTTS_v2.0_BLSpeech-December-11-2023_02+17PM-0000000'
