...
class TTS(nn.Module):
    ...
    def __init__(
        ...
        if model_name is not None:
            if "tts_models" in model_name or "coqui_studio" in model_name:
                self.load_tts_model_by_name(model_name, model_dir, gpu)
    ...
    def load_tts_model_by_name(self, model_name: str, model_dirs: str, gpu: bool = False):
    ...
    def tts_to_file(
        ...
        **kwargs,
        ...
        wav = self.tts(text=text, speaker=speaker, language=language, speaker_wav=speaker_wav, speaker_id=speaker_id, **kwargs)
